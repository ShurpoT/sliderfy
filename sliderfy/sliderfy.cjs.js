...
const Sliderfy = ({
  ...
  const [sliderSize, setSliderSize] = react.useState({ w: 0, h: 0 });
  ...
  const generateDots = () => renderDot && /* @__PURE__ */ jsxRuntime.jsx("ul", { className: `sliderfy__dots ${sliderfyClassName}__dots`, children: Array.from(
    { length: dotsCount },
    (_, i) => renderDot(
      i,
  ...
  const generateArrows = () => ["prev", "next"].map((direction, i) => /* @__PURE__ */ jsxRuntime.jsx(
    "div",
    {
  ...
  if (!children) return;
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `sliderfy sliderfy-${vertical ? "vertical" : "horizontal"} ${sliderfyClassName}`, children: [
    /* @__PURE__ */ jsxRuntime.jsx("div", { className: `sliderfy__container ${sliderfyClassName}__container`, children: /* @__PURE__ */ jsxRuntime.jsx("div", { className: `sliderfy__wrapper ${sliderfyClassName}__wrapper`, ref: sliderRef, children: generateSlides() }) }),
    generateArrows(),
    generateDots()
  ] });
};
